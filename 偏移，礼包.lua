...
soo=so+0x1722000 --cd
sddz=qi(soo,0x15180)+0x1C8 
rw1 = sooo
rw2=qi(rw1,0x90d98)+0x10
rw3=qi(rw2,0)+0x30
rw4=qi(rw3,0)+0x24c
...
------------------------------
dtaddr    = sddz + 0x233fdfC  --地图
csaddr    = sddz + 0x171a744 --1,065,353,216;1,953,384,757::30(--传送
...
libao={
  ...
  {'SNC85'},{'SNC86'},{'SNC87'},{'CDL5'},
  {'CDL10'}
,{'CDL20'},{'CDL30'},{'CDL40'},{'CDL50'}}
