...
rw1 = sooo
sddz=qi(rw1,0x37b798)+0xC8
rw2=qi(rw1,0xab0f0)+0x10
rw3=qi(rw2,0)+0x30
rw4=qi(rw3,0)+0x29c
...
------------------------------
dtaddr    = sddz + 0x326c6ec  --地图
csaddr    = sddz + 0x1a519c4 --1,065,353,216;1,953,384,757::30(--传送
...
libao={
  ...
  {'SNC105'},{'SNC106'},{'SNC107'},{'SNC108'},{'SNC109'}
