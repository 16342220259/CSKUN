...
soo=so+0x15ef000 --cd
sddz=qi(soo,0x13ec0)+0x1C8 
rw1 = sooo
rw2=qi(rw1,0x8d258)+0x10
rw3=qi(rw2,0)+0x30
rw4=qi(rw3,0)+0x1fc
rwdz=rw4
--
...
------------------------------
dtaddr    = sddz + 0x22e0260 --地图
csaddr    = sddz + 0x15d8fd8 --1,065,353,216;1,953,384,757::30(--传送
...
zdlz=sddz+0x47d654+0xc--自动购买开关
zdlz1=zdlz+4
------------------------------
lzjs=rwdz+0x9be0 - 0x10 --1066C-- -2015F0-季节蜡烛
